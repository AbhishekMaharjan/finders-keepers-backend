...
public class PasswordAuthenticationConverter implements AuthenticationConverter {
    private final IntermediateHandler parametersExtractor;

    public PasswordAuthenticationConverter(IntermediateHandler parametersExtractor) {
    ...
    public Authentication convert(HttpServletRequest request) {
        ...
        if (!grantType.equals("password"))
            return null;
        MultiValueMap<String, String> parameters = parametersExtractor.getParameters(request);
